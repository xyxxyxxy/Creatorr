...
| [download-and-library.md](download-and-library.md) | Download pipeline, remux (always MKV + why), retention, file sync, series/domain gates |
| [stream-proxy.md](stream-proxy.md) | Stream delivery mode, .strm pack, HTTP proxy, External Creatorr URL |
