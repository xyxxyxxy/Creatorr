...
- Integrity check ok (`integrity_checked`; legacy History may still say `verified`) or fail (`integrity_check_failed` + status `integrity_check_failed`; file kept; `IntegrityCheckFailed`).
