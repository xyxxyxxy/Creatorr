...
func (h *Handler) Mount(r chi.Router) {
	...
	r.Get("/series/{id}/videos/ids", h.seriesVideoIDsJSON)
	r.Post("/videos/bulk-metadata-common", h.videoBulkMetadataCommonJSON)
	...
	r.Get("/settings/connect/ytdlp-installed-version", h.settingsConnectYtDlpInstalledVersion)
	r.Get("/settings/connect/ytdlp-last-checked", h.settingsConnectYtDlpLastChecked)
	...
	r.Post("/actions/bulk-edit-series", h.actionBulkEditSeries)
	r.Post("/actions/bulk-edit-series-metadata", h.actionBulkEditSeriesMetadata)
	...
	r.Post("/actions/skip-domain-cooldown", h.actionSkipDomainCooldown)
	r.Post("/actions/task-to-front", h.actionTaskToFront)
